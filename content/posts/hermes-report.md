---
title: Hermes Report
date: 2026-05-09T14:01:05+08:00
draft: false
tags:
  - Hermes
  - 自动化
...
| `ai-native-app-design` | `productivity` | 今日创建 | 沉淀 AI-native 产品设计原则：生成式界面、上下文感知、成长回路、用户主权和渐进式自动化。 |
| `cdn-upload-html` | `bytedance` | 今日创建并更新 | 将 Hermes 生成的 HTML artifact 上传到 CDN；默认使用当前验证更稳定的 CN 路径，并保留其他区域探测经验。 |
